...
void main() {
  group('Delta E Tests', () {
    ...
    test('CIE76 Calculation', () {
      ...
      final c1 = LabColor(50, 10, 10);
      final c2 = LabColor(50, 20, 20);
      expect(c1.deltaE(c2, algorithm: DeltaEAlgorithm.cie76), closeTo(14.14, 0.01));
    });
    ...
    test('CIEDE2000 L-only difference', () {
      ...
      final c1 = LabColor(50, 0, 0);
      final c2 = LabColor(60, 0, 0);
      expect(c1.deltaE(c2, algorithm: DeltaEAlgorithm.ciede2000), closeTo(9.47, 0.1));
    });
    ...
    test('CIEDE2000 a-only difference', () {
      ...
      final c1 = LabColor(50, 0, 0);
      final c2 = LabColor(50, 10, 0);
      expect(c1.deltaE(c2, algorithm: DeltaEAlgorithm.ciede2000), closeTo(11.2, 0.5));
    });
    ...
    test('CIEDE2000 b-only difference', () {
      ...
      final c1 = LabColor(50, 0, 0);
      final c2 = LabColor(50, 0, 10);
      expect(c1.deltaE(c2, algorithm: DeltaEAlgorithm.ciede2000), closeTo(8.16, 0.1));
    });
