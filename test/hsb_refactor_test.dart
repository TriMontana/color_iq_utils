...
void main() {
  group('HsbColor Refactor Tests', () {
    test('whiten increases brightness and desaturates', () {
      final HsbColor color = HsbColor.alt(0, 1.0, 0.5); // Dark Red
    ...
    test('blacken decreases brightness and desaturates', () {
      final HsbColor color = HsbColor.alt(0, 1.0, 0.5); // Red
    ...
    test('lerp interpolates correctly', () {
      final HsbColor start = HsbColor.alt(0, 1.0, 0.5); // Red
      final HsbColor end = HsbColor.alt(120, 1.0, 0.5); // Green
    ...
    test('intensify increases saturation', () {
      final HsbColor color = HsbColor.alt(0, 0.5, 0.5);
