...
void main() {
  group('YiqColor Refactor Tests', () {
    test('whiten increases brightness', () {
      final YiqColor color = YiqColor(0.5, 0.0, 0.0); // Gray
    ...
    test('lerp interpolates correctly', () {
      final YiqColor start = YiqColor(0.5, 0.0, 0.0); // Gray
      final YiqColor end = YiqColor(1.0, 0.0, 0.0); // White
    ...
    test('saturate increases chrominance', () {
      final YiqColor color = YiqColor(0.5, 0.1, 0.1);
