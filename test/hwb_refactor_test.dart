...
void main() {
  group('HwbColor Refactor Tests', () {
    ...
    test('blacken increases blackness', () {
      ...
      expect(blackened.blackness, greaterThan(color.b));
    ...
    test('lerp interpolates correctly', () {
      ...
      expect(mid.blackness, closeTo(0, 0.01));
    });
    ...
    test('saturate decreases w and b', () {
      ...
      expect(saturated.blackness, lessThan(color.b));
    });
    ...
    test('desaturate increases w and b', () {
      ...
      expect(desaturated.blackness, greaterThan(color.b));
    });
  });
}
