...
void main() {
  group('CSS String Tests', () {
    test('toCssString Hex', () {
      const ColorIQ c = ColorIQ(0xFFFF0000);
      expect(c.toCssString(space: CssColorSpace.hex), equals('#ff0000'));
      
      const ColorIQ cAlpha = ColorIQ(0x80FF0000);
    ...
    test('toCssString RGB', () {
      ...
      const ColorIQ cAlpha = ColorIQ(0x80FF0000); // 128/255 = 0.5019
    ...
    test('fromCssString RGB', () {
      ...
      final ColorSpacesIQ cAlpha = CssColor.fromCssString('rgba(255, 0, 0, 0.5)');
