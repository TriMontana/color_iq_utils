...
void main() {
  group('YuvColor Tests', () {
    ...
    test('whiten moves towards white', () {
      final YuvColor color = YuvColor(0.0, 0.1, 0.1); // Black-ish with color
    ...
    test('blacken moves towards black', () {
      final YuvColor color = YuvColor(1.0, 0.1, 0.1); // White-ish with color
    ...
    test('lerp interpolates correctly', () {
      final YuvColor color1 = YuvColor(0.0, 0.0, 0.0);
      final YuvColor color2 = YuvColor(1.0, 1.0, 1.0);
