...
void main() {
  group('YuvColor Tests', () {
    ...
    test('whiten moves towards white', () {
      final YuvColor color =
          YuvColor.alt(0.0, 0.1, 0.1); // Black-ish with color
    ...
    test('blacken moves towards black', () {
      final YuvColor color =
          YuvColor.alt(1.0, 0.1, 0.1); // White-ish with color
    ...
    test('lerp interpolates correctly', () {
      ...
      final YuvColor color2 = YuvColor.alt(1.0, 1.0, 1.0);
