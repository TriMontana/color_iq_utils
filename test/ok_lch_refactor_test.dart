  ...
  group('OkLchColor Refactor Tests', () {
    test('whiten increases lightness', () {
      final OkLchColor color =
          OkLchColor.alt(const Percent(0.5), 0.2, 0); // Red-ish
    ...
    test('lerp interpolates correctly', () {
      final OkLchColor start =
          OkLchColor.alt(const Percent(0.5), 0.2, 0); // Red-ish
      final OkLchColor end =
          OkLchColor.alt(const Percent(0.5), 0.2, 120); // Green-ish
    ...
    test('lerp handles hue wrapping', () {
      final OkLchColor start = OkLchColor.alt(const Percent(0.5), 0.2, 350);
      final OkLchColor end = OkLchColor.alt(const Percent(0.5), 0.2, 10);
      final OkLchColor mid = start.lerp(end, 0.5);
    ...
    test('adjustHue works', () {
      final OkLchColor color = OkLchColor.alt(const Percent(0.5), 0.2, 0);
    ...
    test('cooler shifts hue towards 210', () {
      final OkLchColor color = OkLchColor.alt(const Percent(0.5), 0.2, 180);
