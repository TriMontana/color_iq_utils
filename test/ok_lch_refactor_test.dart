...
void main() {
  group('OkLchColor Refactor Tests', () {
    test('whiten increases lightness', () {
      const OkLchColor color = OkLchColor(0.5, 0.2, 0); // Red-ish
    ...
    test('lerp interpolates correctly', () {
      const OkLchColor start = OkLchColor(0.5, 0.2, 0); // Red-ish
      const OkLchColor end = OkLchColor(0.5, 0.2, 120); // Green-ish
    ...
    test('lerp handles hue wrapping', () {
      const OkLchColor start = OkLchColor(0.5, 0.2, 350);
      const OkLchColor end = OkLchColor(0.5, 0.2, 10);
      final OkLchColor mid = start.lerp(end, 0.5);
    ...
    test('adjustHue works', () {
      const OkLchColor color = OkLchColor(0.5, 0.2, 0);
    ...
    test('cooler shifts hue towards 210', () {
      const OkLchColor color = OkLchColor(0.5, 0.2, 180);
