...
void main() {
  group('HspColor Refactor Tests', () {
    test('whiten increases brightness and desaturates', () {
      const HspColor color = HspColor(0, 1.0, 0.5); // Dark Red
    ...
    test('blacken decreases brightness and desaturates', () {
      const HspColor color = HspColor(0, 1.0, 1.0); // Red
    ...
    test('lerp interpolates correctly', () {
      const HspColor start = HspColor(0, 1.0, 1.0); // Red
      const HspColor end = HspColor(120, 1.0, 1.0); // Green
    ...
    test('intensify increases saturation', () {
      const HspColor color = HspColor(0, 0.5, 1.0);
