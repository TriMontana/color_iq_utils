...
void main() {
  group('ColorDescriptor', () {
    ...
    test('Chromatic colors', () {
      // Red
      expect(
        ColorDescriptor.describe(const HSL(0, 1.0, 0.5)),
        'Vivid Red',
      );
      ...
      // Pastel Red (Pinkish)
      expect(
        ColorDescriptor.describe(const HSL(0, 0.3, 0.8)),
        'Pastel Red',
      );
      // L=0.8, S=0.3 -> Pastel

      // Deep Red
      expect(ColorDescriptor.describe(const HSL(0, 1.0, 0.3)), 'Deep Red');
      // L=0.3, S=1.0 -> Deep

      // Dark Red
      expect(ColorDescriptor.describe(const HSL(0, 0.5, 0.3)), 'Dark Red');
      // L=0.3, S=0.5 -> Dark

      // Very Light Blue
      expect(
        ColorDescriptor.describe(const HSL(240, 1.0, 0.9)),
        'Very Light Blue',
      );
      ...
      // Grayish Blue
      expect(
        ColorDescriptor.describe(const HSL(240, 0.15, 0.5)),
        'Grayish Blue',
      );
