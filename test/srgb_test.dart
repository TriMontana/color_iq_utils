...
void main() {
  group('sRGB and Linear sRGB Tests', () {
    ...
    test('ColorIQ linearSrgb getter (Mid Gray)', () {
      const ColorIQ gray = ColorIQ.fromARGB(255, 128, 128, 128);
      // 128/255 = 0.50196
      ...
      print('  Linear sRGB values: [${linear[0].toStringAsFixed(5)}, ${linear[1].toStringAsFixed(5)}, ${linear[2].toStringAsFixed(5)}, ${linear[3]}]');
    });

    test('ColorIQ linearSrgb getter (Dark Gray - Linear Segment)', () {
      const ColorIQ dark = ColorIQ.fromARGB(255, 10, 10, 10);
      // 10/255 = 0.039215
      // 0.039215 / 12.92 = 0.003035
      final List<double> linear = dark.linearSrgb;
      expect(linear[0], closeTo(0.003035, 0.0001));
      
      print('✓ ColorIQ linearSrgb getter (Dark Gray - Linear Segment) test completed');
      print('  Linear sRGB values: [${linear[0].toStringAsFixed(6)}, ${linear[1].toStringAsFixed(6)}, ${linear[2].toStringAsFixed(6)}, ${linear[3]}]');
    });
    ...
    test('Other models delegation (LabColor)', () {
      ...
      print('  LabColor(${lab.l.toStringAsFixed(2)}, ${lab.a.toStringAsFixed(2)}, ${lab.b.toStringAsFixed(2)})');
      print('  sRGB: $srgb');
    });
  });
}
