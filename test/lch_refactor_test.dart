...
void main() {
  group('LchColor Refactor Tests', () {
    test('whiten increases lightness and desaturates', () {
      final LchColor color = LchColor(50, 100, 0); // Red-ish
    ...
    test('lerp interpolates correctly', () {
      final LchColor start = LchColor(50, 100, 0); // Red-ish
      final LchColor end = LchColor(50, 100, 120); // Green-ish
    ...
    test('lerp handles hue wrapping', () {
      final LchColor start = LchColor(50, 100, 350);
      final LchColor end = LchColor(50, 100, 10);
      final LchColor mid = start.lerp(end, 0.5);
    ...
    test('lerp handles achromatic colors', () {
      final LchColor color = LchColor(50, 100, 120);
      final LchColor gray = LchColor(50, 0, 0); // Hue doesn't matter
