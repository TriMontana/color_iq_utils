...
void main() {
  group('Palette Methods Tests', () {
    ...
    test('analogous returns correct count and offset', () {
      const HSL color = HSL(180, 1.0, 0.5); // Cyan

      // Default (count 5, offset 30)
      final List<HSL> palette5 = color.analogous();
      ...
      // Count 3, offset 10
      final List<HSL> palette3 = color.analogous(count: 3, offset: 10);
    ...
    test('square returns 4 colors with 90 degree spacing', () {
      const HSL color = HSL(0, 1.0, 0.5); // Red
      final List<HSL> palette = color.square();
    ...
    test('tetrad returns 4 colors with correct spacing', () {
      ...
      // Default offset 60
      final List<HSL> palette = color.tetrad();
      expect(palette.length, 4);
      expect(palette[0].h, closeTo(0, 1.0));
      ...
      // Custom offset 30
      final List<HSL> palette30 = color.tetrad(offset: 30);
