...
void main() {
  group('HsbColor Methods Tests', () {
    test('grayscale converts to grayscale correctly', () {
      const HsbColor color = HsbColor(0, 1.0, Percent.max);
    ...
    test('inverted inverts color correctly', () {
      const HsbColor color = HsbColor(0, 1.0, Percent.max);
      final HsbColor inverted = HsbColor.fromInt(color.inverted);
    ...
    test('simulate returns same color for none', () {
      const HsbColor color = HsbColor(120, 0.5, Percent.v80);
    ...
    test('simulate achromatopsia results in grayscale', () {
      const HsbColor color = HsbColor(0, 1.0, Percent.max); // Red
    ...
    test('monochromatic generates 5 colors', () {
      const HsbColor color = HsbColor(120, 0.5, Percent.mid);
    ...
    test('random generates valid HsbColor', () {
      const HsbColor color = HsbColor(0, 0, Percent.zero);
    ...
    test('isEqual compares correctly', () {
      const HsbColor c1 = HsbColor(100, 0.5, Percent.mid);
      const HsbColor c2 = HsbColor(100, 0.5, Percent.mid);
      const HsbColor c3 = HsbColor(101, 0.5, Percent.mid);
