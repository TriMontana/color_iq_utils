...
void main() {
  group('OkLabColor Refactor Tests', () {
    test('whiten increases lightness', () {
      final OkLabColor color = OkLabColor(0.5, 0.0, 0.0); // Gray
    ...
    test('lerp interpolates correctly', () {
      final OkLabColor start = OkLabColor(0.0, 0.0, 0.0); // Black
      final OkLabColor end = OkLabColor(1.0, 0.0, 0.0); // White
