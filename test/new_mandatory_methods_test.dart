...
void main() {
  group('New Mandatory Methods Tests', () {
    ...
    test('isEqual', () {
      final c1 = Color.fromARGB(255, 100, 100, 100);
      final c2 = Color.fromARGB(255, 100, 100, 100);
      final c3 = Color.fromARGB(255, 200, 200, 200);
    ...
    test('Brightness', () {
      ...
      final darkGrey = Color.fromARGB(255, 50, 50, 50); // Lum ~ 0.03
      expect(darkGrey.brightness, Brightness.dark);
      
      final lightGrey = Color.fromARGB(255, 200, 200, 200); // Lum ~ 0.5
