...
void main() {
  group('OkLchColor Tests', () {
    test('grayscale sets chroma to 0', () {
      const OkLCH color = OkLCH(Percent.mid, 0.2, 180.0);
    ...
    test('whiten moves towards white', () {
      const OkLCH color = OkLCH(Percent.zero, 0.0, 0.0); // Black
    ...
    test('blacken moves towards black', () {
      const OkLCH color = OkLCH(Percent.max, 0.0, 0.0); // White
    ...
    test('lerp interpolates correctly', () {
      const OkLCH color1 = OkLCH(Percent.zero, 0.0, 0.0);
      const OkLCH color2 = OkLCH(Percent.max, 0.2, 100.0);
