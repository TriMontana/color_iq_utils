...
void main() {
  group('CmykColor Refactor Tests', () {
    test('whiten decreases K', () {
      const CmykColor color = CmykColor(0.0, 0.0, 0.0, 0.5); // Gray
    ...
    test('lerp interpolates correctly', () {
      const CmykColor start = CmykColor(0.0, 0.0, 0.0, 1.0); // Black
      const CmykColor end = CmykColor(0.0, 0.0, 0.0, 0.0); // White
    ...
    test('lighterPalette generates lighter colors', () {
      const CmykColor color = CmykColor(0.0, 0.0, 0.0, 0.5);
