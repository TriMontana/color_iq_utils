...
void main() {
  group('CmykColor Refactor Tests', () {
    test('whiten decreases K', () {
      final CmykColor color = CmykColor.alt(0.0, 0.0, 0.0, 0.5); // Gray
    ...
    test('lerp interpolates correctly', () {
      final CmykColor start = CmykColor.alt(0.0, 0.0, 0.0, 1.0); // Black
      final CmykColor end = CmykColor.alt(0.0, 0.0, 0.0, 0.0); // White
    ...
    test('lighterPalette generates lighter colors', () {
      final CmykColor color = CmykColor.alt(0.0, 0.0, 0.0, 0.5);
