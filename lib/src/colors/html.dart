...
final HTML cAqua = HTML(hxAqua, names: kAqua, hct: null, red: null);
...
final HTML cDarkTurquoise =
    HTML(hxDarkTurquoise, names: kDarkTurquoise, hct: null);
...
final HTML cSteelBlue = HTML(hxSteelBlue, names: kSteelBlue, hct: null);
