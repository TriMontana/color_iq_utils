...
import 'package:coloriq_flutter_adaptor/src/widgets/gradient_box.dart';
import 'package:flutter/material.dart';

/// Must run flutter pub get from this projects directory to install dependencies.
/// Must run flutter pub get from this projects directory to install dependencies.
void main() {
...
class ColorIQDemoApp extends StatelessWidget {
  ...
  Widget build(final BuildContext context) {
    final ColorIQ base =
        cPurple; // ColorIQ.fromHexStr('#BED3E5'); // your example color
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const SizedBox(height: 16),
              gradientBox(harmony[0], harmony[2]),
            ],
          ),
        ),
      ),
